...
const api: LogcutApi = {
  ...
  loadHistory: (projectId) => ipcRenderer.invoke('history:load', projectId),
  saveHistory: (projectId, batches) => ipcRenderer.invoke('history:save', projectId, batches),
  verifyHistory: (projectId) => ipcRenderer.invoke('history:verify', projectId),
